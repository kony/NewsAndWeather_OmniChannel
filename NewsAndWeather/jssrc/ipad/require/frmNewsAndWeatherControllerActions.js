define({
    ...
    */
    ...
    /** onClick defined for flxCat10 **/
    AS_FlexContainer_h31b14fa63d1480499e969cd8a6dd179: function AS_FlexContainer_h31b14fa63d1480499e969cd8a6dd179(eventobject) {
        var self = this;
        this.setCategorySelected(eventobject.id);
    },
    /** onClick defined for flxCat3 **/
    AS_FlexContainer_j4202fcf7c534bfdb07171954681eda7: function AS_FlexContainer_j4202fcf7c534bfdb07171954681eda7(eventobject) {
        var self = this;
        this.setCategorySelected(eventobject.id);
    },
    ...
    /** onClick defined for flxKonyDocumentation **/
    ...
    /** onTouchEnd defined for imgCloseND **/
    AS_Image_fba6298b646f422f838f0450e03a2d63: function AS_Image_fba6298b646f422f838f0450e03a2d63(eventobject, x, y) {
        var self = this;
    ...
    /** onOrientationChange defined for frmNewsAndWeather **/
    AS_Form_i99526dd1f824638ae6bdec5ce71376d: function AS_Form_i99526dd1f824638ae6bdec5ce71376d(eventobject) {
        var self = this;
        this.orientationChangedCallback(eventobject);
    }
});