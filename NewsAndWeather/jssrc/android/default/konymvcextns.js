    ...
    for (var i = 0; i < commandHandlers.length; i++) {
      ...
      if (commandHandlers[i].CommandHandlerExtension && commandHandlers[i].CommandHandlerExtension != null) {
        ...
        try {
          ...
          throw new Exception('ERROR_CODE_300', 'Missing Command Handler Extension ' + JSON.stringify(err));
        }
      } else {
...
DataModel_constants = {
  ...
  XML_REQUEST_OPTIONS: 'xmlRequestOptions'
};
...
DataModel_DBAssembler = function (Error) {
  ...
  assembler.fromDBJson = function (BaseModelClass, config, dbJson) {
    ...
    for (var attribute in attributeMap) {
      ...
      //remove the attributes from prototype
      var modelProto = Object.getPrototypeOf(BaseModelClass);
      var baseModelProto = Object.getPrototypeOf(modelProto);  //TO DO
                                                               //delete baseModelProto.attributeMap[attribute];						
    }
    return retModel;
  };
  return assembler;
...
DataModel_DataSource = function (QueryBuilder, constants, DBAssembler) {
   ...
   * @return 
   */
  DataSource.prototype.getByPrimaryKey = function (BaseModel, config, primaryKey, onCompletion, accessMode) {
    var modelobject;
    var primaykeyobj = {};
    var primarykey;
   ...
   * @return 
   */
  DataSource.prototype.customVerb = function (BaseModel, config, customVerb, params, onCompletion) {
    var modelobject;
   ...
   * @return 
   */
  DataSource.prototype.getByCriteria = function (modelDefination, config, criteria, onCompletion, accessMode) {
    if (accessMode === undefined) {
      accessMode = kony.mvc.MDAApplication.getSharedInstance().getAppMode();
    }
    var modelobject;
   ...
   * @return 
   */
  DataSource.prototype.save = function (BaseModel, config, onCompletion, accessMode) {
    var objSvc;
    if (accessMode === undefined) {
      accessMode = kony.mvc.MDAApplication.getSharedInstance().getAppMode();
    }
    ...
    for (var attribute in attributeMap) {
      ...
      //remove the attributes from prototype
      var modelProto = Object.getPrototypeOf(BaseModel);
      var baseModelProto = Object.getPrototypeOf(modelProto);  //TO DO
                                                               //delete baseModelProto.attributeMap[attribute];	
    }
    var options = {};
   ...
   * @return 
   */
  DataSource.prototype.partialUpdate = function (BaseModel, config, onCompletion, accessMode) {
    var objSvc;
    if (accessMode === undefined) {
      accessMode = kony.mvc.MDAApplication.getSharedInstance().getAppMode();
    }
   ...
   * @return 
   */
  DataSource.prototype.getAll = function (BaseModel, config, onCompletion, accessMode) {
    var modelobject;
    var models = [];
    var objSvc;
    if (accessMode === undefined) {
  ...
  * @param  {BaseModel} BaseModel    model defination
   ...
   * @return 
   */
  DataSource.prototype.update = function (BaseModel, config, onCompletion, accessMode) {
    var objSvc;
    if (accessMode === undefined) {
      accessMode = kony.mvc.MDAApplication.getSharedInstance().getAppMode();
    }
   ...
   * @return
   */
  DataSource.prototype.remove = function (BaseModel, config, onCompletion, accessMode) {
    var dbobject = DBAssembler.toDBJson(BaseModel, config);
    var headers = {};
    headers[constants.SESSIONTOKEN] = kony.mvc.MDAApplication.getSharedInstance().appContext.session_token;
    var objSvc;
  ...
  * @return
  */
  DataSource.prototype.removeById = function (BaseModel, config, primaryKey, onCompletion, accessMode) {
    var modelobject;
    var primaykeyobj = {};
    var primarykey;
    if (primaryKey == null || primaryKey == '' || primaryKey == undefined) {
...
DataModel_BaseRepository = function (DataSource) {
   ...
   * @return
   */
  BaseRepository.prototype.save = function (modelInstance, onCompletion, accessMode) {
    this.datasource.save(modelInstance, this.config, onCompletion, accessMode);
  };
  /**
   * @function update updates the specified model into the backend
   * @param  {BaseModel} modelInstance model object
   ...
   * @return
   */
  BaseRepository.prototype.update = function (modelInstance, onCompletion, accessMode) {
    this.datasource.update(modelInstance, this.config, onCompletion, accessMode);
  };
  /**
   * @function partialUpdate partially update the model data to the backend
   * @param  {BaseModel} modelInstance model object
   ...
   * @return 
   */
  BaseRepository.prototype.partialUpdate = function (modelInstance, onCompletion, accessMode) {
    this.datasource.partialUpdate(modelInstance, this.config, onCompletion, accessMode);
  };
  /**
   * @function remove deletes the specified model from the backend
   * @param  {BaseModel} modelInstance model object
   ...
   * @return
   */
  BaseRepository.prototype.remove = function (modelInstance, onCompletion, accessMode) {
    this.datasource.remove(modelInstance, this.config, onCompletion, accessMode);
  };
  /**
   * @function removeById deletes the specified model from the backend
   * @param  {BaseModel} modelInstance model object
   ...
   * @return
   */
  BaseRepository.prototype.removeById = function (modelInstance, primaryKey, onCompletion, accessMode) {
    this.datasource.removeById(modelInstance, this.config, primaryKey, onCompletion, accessMode);
  };
  /**
   * @function getByPrimaryKey  fetches data for the specified model based on the primary keys
   * @param  {String/JSON} primaryKey   primitive in case of one primary key and json in case of composite primary key
   ...
   * @return 
   */
  BaseRepository.prototype.getByPrimaryKey = function (PrimaryKey, onCompletion, accessMode) {
    this.datasource.getByPrimaryKey(this.modelDefinition, this.config, PrimaryKey, onCompletion, accessMode);
  };
  /**
   * @function getAll fetches  all the records for the specified model
   ...
   * @return 
   */
  BaseRepository.prototype.getAll = function (onCompletion, accessMode) {
    this.datasource.getAll(this.modelDefinition, this.config, onCompletion, accessMode);
  };
  /**
   * @function customVerb fetches data for the specified model using specified customVerb
   * @param  {String} customVerb   name of the custom verb to be executed
   ...
   * @return 
   */
  BaseRepository.prototype.customVerb = function (customVerb, params, onCompletion) {
    this.datasource.customVerb(this.modelDefinition, this.config, customVerb, params, onCompletion);
  };
  /**
   * @function getByCriteria  fetches data for the specified model based on the criteria passed
   * @param  {Json} criteria        criteria object based on which query is build in case of online and offline
   ...
   * @return
   */
  BaseRepository.prototype.getByCriteria = function (criteria, onCompletion, accessMode) {
    this.datasource.getByCriteria(this.modelDefinition, this.config, criteria, onCompletion, accessMode);
  };
  ...
  MDABaseNavigator.prototype.presentForm = function (form, uiTag, viewModel) {
    ...
    if (_currentForm && form == _currentForm.id) {
      ...
      try {
        ...
        throw new Exception('ERROR_CODE_300', 'Error at Navigator, Missing or Wrong UITag ' + JSON.stringify(err));
      }
    }
  };
...
ModuleManager_MDAModule = function (MDABasePresenter, MDABaseNavigator, BusinessController, constants, BusinessDelegator) {
  function MDAModule(moduleName, channel) {
    ...
    try {
      ...
      throw new Exception('ERROR_CODE_600', 'Module Config expected ' + JSON.stringify(e));
    }
    this.setupModule();
  }
    ...
    if (this.moduleConfig === undefined) {
      ...
      if (businessControllerClass === undefined || businessControllerClass === '') {
        ...
        try {
          ...
          throw new Exception('ERROR_CODE_300', 'Invalid Business Controller Class ' + JSON.stringify(err));
        }
      }
    }
    ...
    if (this.moduleConfig === undefined) {
      ...
      if (presentationControllerClass === undefined || presentationControllerClass === '') {
        ...
        try {
          ...
          throw new Exception('ERROR_CODE_300', ' Invalid Presentation Controller Class ' + JSON.stringify(err));
        }
      }
    }
      ...
      if (forms && channel) {
        ...
        for (var eachForm in formsList) {
          if (kony.mvc.registry.getControllerType(eachForm) != constants.FORM_CONTROLLER_TYPE) {
            var formName = formsList[eachForm];
            var friendlyName = forms[channel][formName].FriendlyName || formName;
            var controller = forms[channel][formName].Controller;
            var formController = forms[channel][formName].FormController;
            var controllerExtensions = forms[channel][formName].ControllerExtensions;
    ...
    if (this.moduleConfig !== undefined) {
      ...
      for (var i = 0; i < presentationExtensions.length; i++) {
        try {
          ...
          throw new Exception('ERROR_CODE_300', 'Presentation Controller Extension invalid ' + JSON.stringify(err));
        }
...
DataModel_BaseModel = function (ModelRelation) {
  ...
  */
   ...
   * @return
   */
  BaseModel.prototype.save = function (onCompletion, accessMode) {
    var model = this.constructor.name;
    if (model == undefined) {
      model = (this.constructor.toString().match(/function (.+?)\(/) || [
        ,
        ''
      ])[1];
      kony.mvc.MDAApplication.getSharedInstance().getRepoManager().getRepository(model).save(this, onCompletion, accessMode);
    } else {
      kony.mvc.MDAApplication.getSharedInstance().getRepoManager().getRepository(this.constructor.name).save(this, onCompletion, accessMode);
    }
  };
  /**
   * @function getByPrimaryKey  fetches data for the specified model based on the primary keys
   ...
   * @return 
   */
  BaseModel.getByPrimaryKey = function (PrimaryKey, onCompletion, accessMode) {
    var model = this.name;
    if (model == undefined) {
      model = (this.toString().match(/function (.+?)\(/) || [
        ,
        ''
      ])[1];
      kony.mvc.MDAApplication.getSharedInstance().getRepoManager().getRepository(model).getByPrimaryKey(PrimaryKey, onCompletion, accessMode);
    } else {
      kony.mvc.MDAApplication.getSharedInstance().getRepoManager().getRepository(this.name).getByPrimaryKey(PrimaryKey, onCompletion, accessMode);
    }
  };
  /**
   ...
   * @return
   */
  BaseModel.prototype.update = function (onCompletion, accessMode) {
    var model = this.constructor.name;
    if (model == undefined) {
      model = (this.constructor.toString().match(/function (.+?)\(/) || [
        ,
      ...
      kony.mvc.MDAApplication.getSharedInstance().getRepoManager().getRepository(model).update(this, onCompletion, accessMode);
    } else {
      kony.mvc.MDAApplication.getSharedInstance().getRepoManager().getRepository(this.constructor.name).update(this, onCompletion, accessMode);
    }
  };
  /**
   * @function partialUpdate partially update the model data to the backend
   ...
   * @return 
   */
  BaseModel.prototype.partialUpdate = function (onCompletion, accessMode) {
    var model = this.constructor.name;
    if (model == undefined) {
      model = (this.constructor.toString().match(/function (.+?)\(/) || [
        ,
      ...
      kony.mvc.MDAApplication.getSharedInstance().getRepoManager().getRepository(model).partialUpdate(this, onCompletion, accessMode);
    } else {
      kony.mvc.MDAApplication.getSharedInstance().getRepoManager().getRepository(this.constructor.name).partialUpdate(this, onCompletion, accessMode);
    }
  };
  /**
   * @function remove deletes the specified model from the backend
   ...
   * @return
   */
  BaseModel.remove = function (onCompletion, accessMode) {
    var model = this.name;
    if (model == undefined) {
      model = (this.toString().match(/function (.+?)\(/) || [
        ,
      ...
      kony.mvc.MDAApplication.getSharedInstance().getRepoManager().getRepository(model).remove(this, onCompletion, accessMode);
    } else {
      kony.mvc.MDAApplication.getSharedInstance().getRepoManager().getRepository(this.name).remove(this, onCompletion, accessMode);
    }
  };
  /**
   ...
   * @return
   */
  BaseModel.removeById = function (primaryKey, onCompletion, accessMode) {
    var model = this.name;
    if (model == undefined) {
      model = (this.toString().match(/function (.+?)\(/) || [
        ,
      ...
      kony.mvc.MDAApplication.getSharedInstance().getRepoManager().getRepository(model).removeById(this, primaryKey, onCompletion, accessMode);
    } else {
      kony.mvc.MDAApplication.getSharedInstance().getRepoManager().getRepository(this.name).removeById(this, primaryKey, onCompletion, accessMode);
    }
  };
  /**
   ...
   * @return 
   */
  BaseModel.getAll = function (onCompletion, accessMode) {
    var model = this.name;
    if (model == undefined) {
      model = (this.toString().match(/function (.+?)\(/) || [
        ,
      ...
      kony.mvc.MDAApplication.getSharedInstance().getRepoManager().getRepository(model).getAll(onCompletion, accessMode);
    } else {
      kony.mvc.MDAApplication.getSharedInstance().getRepoManager().getRepository(this.name).getAll(onCompletion, accessMode);
    }
  };
  /**
   * @function customVerb fetches data for the specified model using specified customVerb
   ...
   * @return 
   */
  BaseModel.customVerb = function (customVerb, params, onCompletion) {
    var model = this.name;
    if (model == undefined) {
      model = (this.toString().match(/function (.+?)\(/) || [
        ,
      ...
      kony.mvc.MDAApplication.getSharedInstance().getRepoManager().getRepository(model).customVerb(customVerb, params, onCompletion);
    } else {
      kony.mvc.MDAApplication.getSharedInstance().getRepoManager().getRepository(this.name).customVerb(customVerb, params, onCompletion);
    }
  };
  /**
   * @function getByCriteria  fetches data for the specified model based on the criteria passed
   ...
   * @return
   */
  BaseModel.getByCriteria = function (criteria, onCompletion, accessMode) {
    var model = this.name;
    if (model == undefined) {
      model = (this.toString().match(/function (.+?)\(/) || [
        ,
      ...
      kony.mvc.MDAApplication.getSharedInstance().getRepoManager().getRepository(model).getByCriteria(criteria, onCompletion, accessMode);
    } else {
      kony.mvc.MDAApplication.getSharedInstance().getRepoManager().getRepository(this.name).getByCriteria(criteria, onCompletion, accessMode);
    }
  };
  /**
  ...
  BaseModel.Validator = function (injectedNamedValMap, injectedPropertyValMap) {
    const NamedValidatorMap = injectedNamedValMap ? injectedNamedValMap : {};
    const PropertyToValidatorMap = injectedPropertyValMap ? injectedPropertyValMap : {};
    const getValidations = function (propName) {
    ...
    this.registerValidator = function (propName, validationFn, validationName) {
      const errMsg = 'Unable to register Validator ';
      if (!propName) {
    ...
    this.deRegisterValidator = function (validationName) {
      if (NamedValidatorMap[validationName]) {
        const fnToRemove = NamedValidatorMap[validationName];
